...
public class ServicioUsuarios{
     ...
     * primero comprobar que ninguno de los parámetros es nulo,
     * segundo comprobar que tienen una longitud mínima
     * despues comprobar con expresiones regulares
     * por ultimo comprobar que edad sea mayor que 12
     * 
     * @param email
     * @param password
     * @param nombre
    ...
    public Usuario crearUsuarioValido(String email, String password, String nombre, String edad) {
        ...
        if (email != null && password != null && nombre != null && edad != edad) {
            if (email.length() >= 3
                    && nombre.length() > 1
                    && password.length() >= 4
                    && !"".equals(edad)) {
